 ...
 *
 */
class SellerAcceptOrderProposalSimulateAction extends \OpenActive\Models\OA\OpenBookingSimulateAction
{
    /**
     * @return string[]|null
     */
    ...
    {
        return "test:SellerAcceptOrderProposalSimulateAction";
    }
