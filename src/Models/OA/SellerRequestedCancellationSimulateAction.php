 ...
 *
 */
class SellerRequestedCancellationSimulateAction extends \OpenActive\Models\OA\OpenBookingSimulateAction
{
    /**
     * @return string[]|null
     */
    ...
    {
        return "test:SellerRequestedCancellationSimulateAction";
    }
