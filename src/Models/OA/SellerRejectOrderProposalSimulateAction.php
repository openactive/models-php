 ...
 *
 */
class SellerRejectOrderProposalSimulateAction extends \OpenActive\Models\OA\OpenBookingSimulateAction
{
    /**
     * @return string[]|null
     */
    ...
    {
        return "test:SellerRejectOrderProposalSimulateAction";
    }
