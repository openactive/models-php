 ...
 *
 */
class ChangeOfLogisticsLocationSimulateAction extends \OpenActive\Models\OA\OpenBookingSimulateAction
{
    /**
     * @return string[]|null
     */
    ...
    {
        return "test:ChangeOfLogisticsLocationSimulateAction";
    }
