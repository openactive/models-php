 ...
 *
 */
class LoanPaymentFrequency extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "LoanPaymentFrequency";
    const memberVal = "https://schema.org/loanPaymentFrequency";
}
