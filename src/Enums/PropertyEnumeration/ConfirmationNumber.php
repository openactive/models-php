 ...
 *
 */
class ConfirmationNumber extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "ConfirmationNumber";
    const memberVal = "https://schema.org/confirmationNumber";
}
