 ...
 *
 */
class NonProprietaryName extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "NonProprietaryName";
    const memberVal = "https://schema.org/nonProprietaryName";
}
