 ...
 *
 */
class VehicleSpecialUsage extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "VehicleSpecialUsage";
    const memberVal = "https://schema.org/vehicleSpecialUsage";
}
