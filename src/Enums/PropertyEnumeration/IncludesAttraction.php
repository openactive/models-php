 ...
 *
 */
class IncludesAttraction extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "IncludesAttraction";
    const memberVal = "https://schema.org/includesAttraction";
}
