 ...
 *
 */
class EducationalFramework extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "EducationalFramework";
    const memberVal = "https://schema.org/educationalFramework";
}
