 ...
 *
 */
class InProductGroupWithID extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "InProductGroupWithID";
    const memberVal = "https://schema.org/inProductGroupWithID";
}
