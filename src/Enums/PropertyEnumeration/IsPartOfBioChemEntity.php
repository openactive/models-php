 ...
 *
 */
class IsPartOfBioChemEntity extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "IsPartOfBioChemEntity";
    const memberVal = "https://schema.org/isPartOfBioChemEntity";
}
