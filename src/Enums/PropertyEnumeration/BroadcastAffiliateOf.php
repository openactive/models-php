 ...
 *
 */
class BroadcastAffiliateOf extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "BroadcastAffiliateOf";
    const memberVal = "https://schema.org/broadcastAffiliateOf";
}
