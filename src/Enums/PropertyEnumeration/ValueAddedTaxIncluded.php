 ...
 *
 */
class ValueAddedTaxIncluded extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "ValueAddedTaxIncluded";
    const memberVal = "https://schema.org/valueAddedTaxIncluded";
}
