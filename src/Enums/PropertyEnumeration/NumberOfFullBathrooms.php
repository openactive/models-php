 ...
 *
 */
class NumberOfFullBathrooms extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "NumberOfFullBathrooms";
    const memberVal = "https://schema.org/numberOfFullBathrooms";
}
