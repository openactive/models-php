 ...
 *
 */
class NumberOfLoanPayments extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "NumberOfLoanPayments";
    const memberVal = "https://schema.org/numberOfLoanPayments";
}
