 ...
 *
 */
class EventAttendanceMode extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "EventAttendanceMode";
    const memberVal = "https://schema.org/eventAttendanceMode";
}
