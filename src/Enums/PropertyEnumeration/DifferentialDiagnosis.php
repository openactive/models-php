 ...
 *
 */
class DifferentialDiagnosis extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "DifferentialDiagnosis";
    const memberVal = "https://schema.org/differentialDiagnosis";
}
