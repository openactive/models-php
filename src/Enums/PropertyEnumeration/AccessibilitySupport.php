 ...
 *
 */
class AccessibilitySupport extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "AccessibilitySupport";
    const memberVal = "https://openactive.io/accessibilitySupport";
}
