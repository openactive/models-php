 ...
 *
 */
class IsUnlabelledFallback extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "IsUnlabelledFallback";
    const memberVal = "https://schema.org/isUnlabelledFallback";
}
