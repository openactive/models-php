 ...
 *
 */
class AcceptsReservations extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "AcceptsReservations";
    const memberVal = "https://schema.org/acceptsReservations";
}
