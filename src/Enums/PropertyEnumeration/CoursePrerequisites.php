 ...
 *
 */
class CoursePrerequisites extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "CoursePrerequisites";
    const memberVal = "https://schema.org/coursePrerequisites";
}
