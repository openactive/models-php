 ...
 *
 */
class LegislationApplies extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "LegislationApplies";
    const memberVal = "https://schema.org/legislationApplies";
}
