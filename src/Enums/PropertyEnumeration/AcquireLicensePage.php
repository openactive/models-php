 ...
 *
 */
class AcquireLicensePage extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "AcquireLicensePage";
    const memberVal = "https://schema.org/acquireLicensePage";
}
