 ...
 *
 */
class VehicleInteriorColor extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "VehicleInteriorColor";
    const memberVal = "https://schema.org/vehicleInteriorColor";
}
