 ...
 *
 */
class BroadcastServiceTier extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "BroadcastServiceTier";
    const memberVal = "https://schema.org/broadcastServiceTier";
}
