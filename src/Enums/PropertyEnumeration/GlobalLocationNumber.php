 ...
 *
 */
class GlobalLocationNumber extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "GlobalLocationNumber";
    const memberVal = "https://schema.org/globalLocationNumber";
}
