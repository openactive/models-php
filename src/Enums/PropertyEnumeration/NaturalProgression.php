 ...
 *
 */
class NaturalProgression extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "NaturalProgression";
    const memberVal = "https://schema.org/naturalProgression";
}
