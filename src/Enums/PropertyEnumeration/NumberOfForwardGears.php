 ...
 *
 */
class NumberOfForwardGears extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "NumberOfForwardGears";
    const memberVal = "https://schema.org/numberOfForwardGears";
}
