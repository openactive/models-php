 ...
 *
 */
class MemoryRequirements extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "MemoryRequirements";
    const memberVal = "https://schema.org/memoryRequirements";
}
