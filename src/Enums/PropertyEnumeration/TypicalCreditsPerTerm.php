 ...
 *
 */
class TypicalCreditsPerTerm extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "TypicalCreditsPerTerm";
    const memberVal = "https://schema.org/typicalCreditsPerTerm";
}
