 ...
 *
 */
class BioChemInteraction extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "BioChemInteraction";
    const memberVal = "https://schema.org/bioChemInteraction";
}
