 ...
 *
 */
class HealthPlanNetworkId extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "HealthPlanNetworkId";
    const memberVal = "https://schema.org/healthPlanNetworkId";
}
