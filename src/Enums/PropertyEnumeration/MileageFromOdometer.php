 ...
 *
 */
class MileageFromOdometer extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "MileageFromOdometer";
    const memberVal = "https://schema.org/mileageFromOdometer";
}
