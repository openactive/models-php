 ...
 *
 */
class PriceComponentType extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "PriceComponentType";
    const memberVal = "https://schema.org/priceComponentType";
}
