 ...
 *
 */
class ShippingSettingsLink extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "ShippingSettingsLink";
    const memberVal = "https://schema.org/shippingSettingsLink";
}
