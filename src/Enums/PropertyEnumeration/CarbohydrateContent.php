 ...
 *
 */
class CarbohydrateContent extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "CarbohydrateContent";
    const memberVal = "https://schema.org/carbohydrateContent";
}
