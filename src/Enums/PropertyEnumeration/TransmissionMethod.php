 ...
 *
 */
class TransmissionMethod extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "TransmissionMethod";
    const memberVal = "https://schema.org/transmissionMethod";
}
