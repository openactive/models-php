 ...
 *
 */
class VehicleInteriorType extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "VehicleInteriorType";
    const memberVal = "https://schema.org/vehicleInteriorType";
}
