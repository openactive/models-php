 ...
 *
 */
class LearningResourceType extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "LearningResourceType";
    const memberVal = "https://schema.org/learningResourceType";
}
