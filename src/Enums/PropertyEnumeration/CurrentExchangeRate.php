 ...
 *
 */
class CurrentExchangeRate extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "CurrentExchangeRate";
    const memberVal = "https://schema.org/currentExchangeRate";
}
