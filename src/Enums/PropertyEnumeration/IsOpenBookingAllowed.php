 ...
 *
 */
class IsOpenBookingAllowed extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "IsOpenBookingAllowed";
    const memberVal = "https://openactive.io/isOpenBookingAllowed";
}
