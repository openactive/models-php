 ...
 *
 */
class AnnualPercentageRate extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "AnnualPercentageRate";
    const memberVal = "https://schema.org/annualPercentageRate";
}
