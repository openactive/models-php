 ...
 *
 */
class AccountOverdraftLimit extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "AccountOverdraftLimit";
    const memberVal = "https://schema.org/accountOverdraftLimit";
}
