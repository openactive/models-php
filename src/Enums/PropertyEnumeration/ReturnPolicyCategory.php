 ...
 *
 */
class ReturnPolicyCategory extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "ReturnPolicyCategory";
    const memberVal = "https://schema.org/returnPolicyCategory";
}
