 ...
 *
 */
class BroadcastDisplayName extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "BroadcastDisplayName";
    const memberVal = "https://schema.org/broadcastDisplayName";
}
