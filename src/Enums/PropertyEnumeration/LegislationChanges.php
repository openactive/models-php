 ...
 *
 */
class LegislationChanges extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "LegislationChanges";
    const memberVal = "https://schema.org/legislationChanges";
}
