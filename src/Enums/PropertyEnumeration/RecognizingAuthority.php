 ...
 *
 */
class RecognizingAuthority extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "RecognizingAuthority";
    const memberVal = "https://schema.org/recognizingAuthority";
}
