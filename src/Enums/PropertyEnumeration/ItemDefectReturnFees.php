 ...
 *
 */
class ItemDefectReturnFees extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "ItemDefectReturnFees";
    const memberVal = "https://schema.org/itemDefectReturnFees";
}
