 ...
 *
 */
class EncodesCreativeWork extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "EncodesCreativeWork";
    const memberVal = "https://schema.org/encodesCreativeWork";
}
