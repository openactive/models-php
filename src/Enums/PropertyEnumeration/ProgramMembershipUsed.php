 ...
 *
 */
class ProgramMembershipUsed extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "ProgramMembershipUsed";
    const memberVal = "https://schema.org/programMembershipUsed";
}
