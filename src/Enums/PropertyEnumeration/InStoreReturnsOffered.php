 ...
 *
 */
class InStoreReturnsOffered extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "InStoreReturnsOffered";
    const memberVal = "https://schema.org/inStoreReturnsOffered";
}
