 ...
 *
 */
class BenefitsSummaryUrl extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "BenefitsSummaryUrl";
    const memberVal = "https://schema.org/benefitsSummaryUrl";
}
