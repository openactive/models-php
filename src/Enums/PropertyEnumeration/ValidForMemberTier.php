 ...
 *
 */
class ValidForMemberTier extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "ValidForMemberTier";
    const memberVal = "https://schema.org/validForMemberTier";
}
