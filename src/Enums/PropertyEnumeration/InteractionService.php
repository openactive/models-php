 ...
 *
 */
class InteractionService extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "InteractionService";
    const memberVal = "https://schema.org/interactionService";
}
