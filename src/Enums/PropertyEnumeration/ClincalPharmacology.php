 ...
 *
 */
class ClincalPharmacology extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "ClincalPharmacology";
    const memberVal = "https://schema.org/clincalPharmacology";
}
