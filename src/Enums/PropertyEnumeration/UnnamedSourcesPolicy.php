 ...
 *
 */
class UnnamedSourcesPolicy extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "UnnamedSourcesPolicy";
    const memberVal = "https://schema.org/unnamedSourcesPolicy";
}
