 ...
 *
 */
class MeasurementTechnique extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "MeasurementTechnique";
    const memberVal = "https://schema.org/measurementTechnique";
}
