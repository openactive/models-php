 ...
 *
 */
class KnownVehicleDamages extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "KnownVehicleDamages";
    const memberVal = "https://schema.org/knownVehicleDamages";
}
