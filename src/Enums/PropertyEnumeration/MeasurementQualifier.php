 ...
 *
 */
class MeasurementQualifier extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "MeasurementQualifier";
    const memberVal = "https://schema.org/measurementQualifier";
}
