 ...
 *
 */
class LegislationPassedBy extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "LegislationPassedBy";
    const memberVal = "https://schema.org/legislationPassedBy";
}
