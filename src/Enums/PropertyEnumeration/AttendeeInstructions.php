 ...
 *
 */
class AttendeeInstructions extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "AttendeeInstructions";
    const memberVal = "https://openactive.io/attendeeInstructions";
}
