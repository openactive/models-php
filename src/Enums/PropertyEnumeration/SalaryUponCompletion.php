 ...
 *
 */
class SalaryUponCompletion extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "SalaryUponCompletion";
    const memberVal = "https://schema.org/salaryUponCompletion";
}
