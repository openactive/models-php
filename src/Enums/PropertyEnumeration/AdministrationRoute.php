 ...
 *
 */
class AdministrationRoute extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "AdministrationRoute";
    const memberVal = "https://schema.org/administrationRoute";
}
