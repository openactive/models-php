 ...
 *
 */
class AggregateFacilityUse extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "AggregateFacilityUse";
    const memberVal = "https://openactive.io/aggregateFacilityUse";
}
