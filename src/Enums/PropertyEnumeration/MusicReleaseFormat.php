 ...
 *
 */
class MusicReleaseFormat extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "MusicReleaseFormat";
    const memberVal = "https://schema.org/musicReleaseFormat";
}
