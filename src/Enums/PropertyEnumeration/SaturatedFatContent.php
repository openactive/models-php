 ...
 *
 */
class SaturatedFatContent extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "SaturatedFatContent";
    const memberVal = "https://schema.org/saturatedFatContent";
}
