 ...
 *
 */
class EntertainmentBusiness extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "EntertainmentBusiness";
    const memberVal = "https://schema.org/entertainmentBusiness";
}
