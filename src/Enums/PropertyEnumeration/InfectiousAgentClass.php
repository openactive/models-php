 ...
 *
 */
class InfectiousAgentClass extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "InfectiousAgentClass";
    const memberVal = "https://schema.org/infectiousAgentClass";
}
