 ...
 *
 */
class LegislationLegalValue extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "LegislationLegalValue";
    const memberVal = "https://schema.org/legislationLegalValue";
}
