 ...
 *
 */
class ProcessorRequirements extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "ProcessorRequirements";
    const memberVal = "https://schema.org/processorRequirements";
}
