 ...
 *
 */
class AssociatedClaimReview extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "AssociatedClaimReview";
    const memberVal = "https://schema.org/associatedClaimReview";
}
