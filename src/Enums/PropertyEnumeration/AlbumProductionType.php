 ...
 *
 */
class AlbumProductionType extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "AlbumProductionType";
    const memberVal = "https://schema.org/albumProductionType";
}
