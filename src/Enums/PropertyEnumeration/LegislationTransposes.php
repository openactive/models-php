 ...
 *
 */
class LegislationTransposes extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "LegislationTransposes";
    const memberVal = "https://schema.org/legislationTransposes";
}
