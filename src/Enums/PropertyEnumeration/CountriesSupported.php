 ...
 *
 */
class CountriesSupported extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "CountriesSupported";
    const memberVal = "https://schema.org/countriesSupported";
}
