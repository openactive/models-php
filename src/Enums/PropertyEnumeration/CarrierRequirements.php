 ...
 *
 */
class CarrierRequirements extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "CarrierRequirements";
    const memberVal = "https://schema.org/carrierRequirements";
}
