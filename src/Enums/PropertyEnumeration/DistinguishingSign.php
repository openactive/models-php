 ...
 *
 */
class DistinguishingSign extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "DistinguishingSign";
    const memberVal = "https://schema.org/distinguishingSign";
}
