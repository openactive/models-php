 ...
 *
 */
class OrderItemIntakeForm extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "OrderItemIntakeForm";
    const memberVal = "https://openactive.io/orderItemIntakeForm";
}
