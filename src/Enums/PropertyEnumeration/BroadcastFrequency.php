 ...
 *
 */
class BroadcastFrequency extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "BroadcastFrequency";
    const memberVal = "https://schema.org/broadcastFrequency";
}
