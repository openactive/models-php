 ...
 *
 */
class RecipeInstructions extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "RecipeInstructions";
    const memberVal = "https://schema.org/recipeInstructions";
}
