 ...
 *
 */
class ScheduledEventType extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "ScheduledEventType";
    const memberVal = "https://openactive.io/scheduledEventType";
}
