 ...
 *
 */
class DurationOfWarranty extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "DurationOfWarranty";
    const memberVal = "https://schema.org/durationOfWarranty";
}
