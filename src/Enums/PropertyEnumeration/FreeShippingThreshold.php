 ...
 *
 */
class FreeShippingThreshold extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "FreeShippingThreshold";
    const memberVal = "https://schema.org/freeShippingThreshold";
}
