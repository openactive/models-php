 ...
 *
 */
class AccessibilitySummary extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "AccessibilitySummary";
    const memberVal = "https://schema.org/accessibilitySummary";
}
