 ...
 *
 */
class AccountMinimumInflow extends \OpenActive\Enums\PropertyEnumeration
{
    const value = "AccountMinimumInflow";
    const memberVal = "https://schema.org/accountMinimumInflow";
}
