 ...
 *
 */
class PhoneCarrierPayment extends \OpenActive\Enums\SchemaOrg\PaymentMethodType
{
    const value = "PhoneCarrierPayment";
    const memberVal = "https://schema.org/PhoneCarrierPayment";
}
