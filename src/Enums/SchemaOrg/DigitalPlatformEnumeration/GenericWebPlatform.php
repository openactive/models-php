...
namespace OpenActive\Enums\SchemaOrg\DigitalPlatformEnumeration;
 ...
 *
 */
class GenericWebPlatform extends \OpenActive\Enums\SchemaOrg\DigitalPlatformEnumeration
{
    const value = "GenericWebPlatform";
    const memberVal = "https://schema.org/GenericWebPlatform";
}
