 ...
 *
 */
class AndroidPlatform extends \OpenActive\Enums\SchemaOrg\DigitalPlatformEnumeration
{
    const value = "AndroidPlatform";
    const memberVal = "https://schema.org/AndroidPlatform";
}
