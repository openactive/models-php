 ...
 *
 */
class MobileWebPlatform extends \OpenActive\Enums\SchemaOrg\DigitalPlatformEnumeration
{
    const value = "MobileWebPlatform";
    const memberVal = "https://schema.org/MobileWebPlatform";
}
