 ...
 *
 */
class ContagiousnessHealthAspect extends \OpenActive\Enums\SchemaOrg\HealthAspectEnumeration
{
    const value = "ContagiousnessHealthAspect";
    const memberVal = "https://schema.org/ContagiousnessHealthAspect";
}
