 ...
 *
 */
class SelfCareHealthAspect extends \OpenActive\Enums\SchemaOrg\HealthAspectEnumeration
{
    const value = "SelfCareHealthAspect";
    const memberVal = "https://schema.org/SelfCareHealthAspect";
}
