 ...
 *
 */
class StagesHealthAspect extends \OpenActive\Enums\SchemaOrg\HealthAspectEnumeration
{
    const value = "StagesHealthAspect";
    const memberVal = "https://schema.org/StagesHealthAspect";
}
