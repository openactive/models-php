...
namespace OpenActive\Enums\SchemaOrg\HealthAspectEnumeration;
 ...
 *
 */
class MisconceptionsHealthAspect extends \OpenActive\Enums\SchemaOrg\HealthAspectEnumeration
{
    const value = "MisconceptionsHealthAspect";
    const memberVal = "https://schema.org/MisconceptionsHealthAspect";
}
