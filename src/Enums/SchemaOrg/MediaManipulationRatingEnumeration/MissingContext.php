 ...
 *
 */
class MissingContext extends \OpenActive\Enums\SchemaOrg\MediaManipulationRatingEnumeration
{
    const value = "MissingContext";
    const memberVal = "https://schema.org/MissingContext";
}
