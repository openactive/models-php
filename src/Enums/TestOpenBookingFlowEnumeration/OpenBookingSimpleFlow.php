...
namespace OpenActive\Enums\TestOpenBookingFlowEnumeration;
 ...
 *
 */
class OpenBookingSimpleFlow extends \OpenActive\Enums\TestOpenBookingFlowEnumeration
{
    const value = "OpenBookingSimpleFlow";
    const memberVal = "https://openactive.io/test-interface#OpenBookingSimpleFlow";
}
