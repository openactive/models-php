...
class DayOfWeek
{
    const Wednesday = \OpenActive\Enums\OA\DayOfWeek\Wednesday::class;
    const Sunday = \OpenActive\Enums\OA\DayOfWeek\Sunday::class;
    const PublicHolidays = \OpenActive\Enums\OA\DayOfWeek\PublicHolidays::class;
    const Monday = \OpenActive\Enums\OA\DayOfWeek\Monday::class;
    const Friday = \OpenActive\Enums\OA\DayOfWeek\Friday::class;
    const Tuesday = \OpenActive\Enums\OA\DayOfWeek\Tuesday::class;
    const Saturday = \OpenActive\Enums\OA\DayOfWeek\Saturday::class;
    const Thursday = \OpenActive\Enums\OA\DayOfWeek\Thursday::class;
}
